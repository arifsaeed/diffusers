...
export image_list_path="lambdalabs/pokemon-blip-captions"
export TRAIN_DATA_DIR=""
export LABEL_DATA_DIR=""
...
accelerate launch --mixed_precision="fp16"  train_text_to_image.py \
  ...
  --train_data_root=$TRAIN_DATA_DIR \
  --label_data_root=$LABEL_DATA_DIR \
  --prompt="fix the eyes only"
```
